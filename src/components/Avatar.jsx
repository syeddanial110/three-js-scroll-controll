...
export function Avatar(props) {
  ...
  const { animations: jumpingAnimation } = useFBX("animations/Dancing 2.fbx");
  ...
  // console.log("jumpingAnimation", jumpingAnimation);
  // // console.log("standingAnimation", standingAnimation);
